...
export default function OrderHeader({
    ...
    const formattedDate =
        typeof orderDate === "string"
            ? orderDate
            : format(orderDate, "EEE, d MMM h:mm a");

    return (
        <div
            className={cn(
                "w-full  border-b border-[#A4A4A429]   px-6 py-[18px] bg-[#FFFFFF]",
                className
            )}
        >
            <div className="flex items-center justify-between gap-6 ">
                ...
                <div className="flex-1 flex items-start gap-4">
                    ...
                    <div className="shrink-0 w-[60px] h-[60px] rounded-full bg-[#4F6BED]/10 flex items-center justify-center">
                        <img src={HugeiconsContactIcon} className="w-[32.66666603088379px] h-[32.666671752929688px]" />
                    </div>
