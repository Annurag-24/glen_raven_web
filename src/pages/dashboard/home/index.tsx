      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 relative">
        <div className="relative">
          <SearchCommand
            ...
            filterFn={(order, search) => order.orderNumber?.toString().includes(search) ?? false}
        ...
        <div className="relative">
          <SearchCommand
            ...
            filterFn={(customer, search) => {
              ...
              return (
                (customer.companyName?.toLowerCase().includes(lowerSearch) ?? false) ||
                (customer.contactName?.toLowerCase().includes(lowerSearch) ?? false) ||
                (customer.email?.toLowerCase().includes(lowerSearch) ?? false) ||
                (customer.phone?.toLowerCase().includes(lowerSearch) ?? false) ||
                (customer.customerId?.toString().includes(search) ?? false)
              );
            }}
