...
describe('Login Component', () => {
  ...
  it('renders login form with all elements', () => {
    ...
    expect(
      screen.getByText(/Enter your email address and we'll send you a secure login link/i)
    ).toBeInTheDocument();
  ...
  it('allows user to type in email input', async () => {
    ...
    const emailInput = screen.getByPlaceholderText('@sample.com') as HTMLInputElement;
