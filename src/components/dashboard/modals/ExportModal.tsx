...
export default function ExportModal({
  ...
  // Compute initial state based on current props instead of using effect
  ...
  function handleExport() {
    const selectedKeys = columns.filter((c) => selected[c.key]).map((c) => c.key);
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <div>
          <h4 className="text-sm font-medium text-gray-900">Columns to Include</h4>
