...
export default function CreditHoldCard() {
  return (
    <DashboardCard title="Orders on Credit Hold" showViewAll wrapperClassName="w-full">
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                ...
                <div className="text-sm text-[#6B7280]">{d.name}</div>
              ...
              <div className="flex flex-col items-end justify-between">
                <div className="mb-2 text-right">
                  ...
                  <div className="mt-2">
                    <Badge variant={d.badge.variant as BadgeVariant} title={d.badge.label} />
                  </div>
                </div>
              </div>
            </div>
