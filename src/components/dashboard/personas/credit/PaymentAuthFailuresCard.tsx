...
export default function PaymentAuthFailuresCard() {
  return (
    <DashboardCard title="Payment Authorization Failures" showViewAll wrapperClassName="w-full">
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                <CardPrimaryText className="mb-1">Order: {d.order}</CardPrimaryText>
                <div className="text-sm text-gray-600">{d.card}</div>
                <CardSecondaryText>Attempts: {d.attempts}</CardSecondaryText>

                <div className="mt-2 text-sm text-[#DC2626]">{d.error}</div>
              ...
              <div className="flex flex-col items-end justify-between">
                <div className="text-lg font-semibold text-gray-800">{d.amount}</div>
              </div>
            </div>
          </div>
        ))}
