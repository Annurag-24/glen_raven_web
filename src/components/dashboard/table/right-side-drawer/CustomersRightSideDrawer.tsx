...
const CustomersRightSideDrawer: React.FC<ICustomersRightSideDrawer> = ({ isOpen, onClose }) => {
...
const Details = () => {
  ...
  return (
    <RightSideDrawerCard title="Details" icon={DetailsIcon} iconBgColor="bg-indigo-100">
        ...
        {details.map((detail) => (
          <div className="w-full flex flex-col gap-1" key={detail.label}>
            ...
            <div className="w-full flex items-center">
              <RightSideDrawerCardValue>{detail.value}</RightSideDrawerCardValue>
            </div>
          </div>
        ))}
      </div>
...
const Contacts = () => {
  ...
  return (
    <RightSideDrawerCard title="Contacts" icon={ContactsIcon} iconBgColor="bg-yellow-100">
      <div className="w-full flex flex-col gap-4">
        {contacts.map((contact) => (
          <div className="w-full flex flex-col gap-1" key={contact.label}>
            ...
            <div className="w-full flex items-center justify-between">
              <RightSideDrawerCardValue>{contact.value}</RightSideDrawerCardValue>
