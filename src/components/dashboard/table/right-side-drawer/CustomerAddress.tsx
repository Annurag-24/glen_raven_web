  ...
  return (
    <RightSideDrawerAccordion title="Customer Address">
      <div className="flex flex-col gap-2">
        ...
        />
        <RightSideDrawerAccordionItem label="Bill To" value="789 delivery Road, Seattle, WA" />
        <RightSideDrawerAccordionItem label="Sold To" value="321 main Street, Austin, TX" />
      </div>
    </RightSideDrawerAccordion>
  );
};
