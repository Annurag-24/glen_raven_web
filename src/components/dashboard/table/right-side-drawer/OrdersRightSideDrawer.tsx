...
const OrdersRightSideDrawer: React.FC<IOrdersRightSideDrawer> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="space-y-2">
      <div className="px-4 py-3 bg-gray-50 rounded-md outline-1 -outline-offset-1 outline-gray-100 flex justify-between items-center">
        ...
        <div className="justify-center text-tertiary text-sm font-extrabold leading-3">03</div>
      </div>
